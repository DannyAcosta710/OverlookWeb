...
INSERT [dbo].[Mapa] ([ID_Mapa], [Nombre], [Descripcion], [Tipo], [Imagen]) VALUES (6, N'Ruta 66', N'Aunque los viajeros que solían cruzar los Estados Unidos en la histórica Ruta 66 han desaparecido, la Calle Mayor de Estados Unidos aún se mantiene, como testamento de unos tiempos más simples. Las estaciones de gasolina, tiendas de carretera y cafés han entrado en desuso, y el legendario cañón Deadlock es mayormente visto desde la comodidad de tren-carros transcontinentales. Pero entre los monumentos de esa era anterior, los bandidos de la banda Deadlock están planeando su robo más grande hasta el momento.', N'Escolta', N'http://vignette4.wikia.nocookie.net/overwatch/images/4/49/Route66_7.png/revision/latest?cb=20160323030910')
INSERT [dbo].[Mapa] ([ID_Mapa], [Nombre], [Descripcion], [Tipo], [Imagen]) VALUES (7, N'Torre Lijiang', N'La Torre Lijiand fue construida en el corazón de una moderna metrópolis china, cuyas ocupadas calles bordeadas de tiendas, jardines, restaurantes y famosos mercados nocturnos, donde comidas de toda la región yacen disponibles a toda hora. La torre en sí es el hogar de una de las compañías líderes en lo último de la industria espacial, Lucheng Interestelar, una organización con una larga historia como pionera, que está actualmente empujando los límites de la exploración espacial.
